...
import com.example.triparrangersfyp.Adapter.PlacesListAdapter;
import com.example.triparrangersfyp.nearbyareas.mapmodel.PlacesResults;
import com.example.triparrangersfyp.nearbyareas.mapmodel.Result;
        ...
        btn_nearby.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (selectedCat.equals("Select Nearby Areas")) {
                    ...
                    else if (selectedCat.equals("Hotels")) {
                    ...
                    else if (selectedCat.equals("Restaurants")) {
                        initView(current_lat, current_lng, "restaurants");
                    }

                    else if (selectedCat.equals("Hospitals")) {
                        initView(current_lat, current_lng, "hospitals");
                    }
                }
            }
        });
...
//                    locationManager.requestLocationUpdates(LocationManager.GPS_PROVIDER, 2 * 1000, 1);
            ...
            if (ContextCompat.checkSelfPermission(NearByAreasActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                ActivityCompat.requestPermissions(NearByAreasActivity.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, 12);
            }
            if (ContextCompat.checkSelfPermission(NearByAreasActivity.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
