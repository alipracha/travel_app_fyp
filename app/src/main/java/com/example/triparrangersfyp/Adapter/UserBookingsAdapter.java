...
import com.example.triparrangersfyp.Tourist.ViewMyBookings_User;
...
public class UserBookingsAdapter extends BaseAdapter {
    ...
    public UserBookingsAdapter(List<RequestBooking> requestList, Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView tv_show_CName = convertView.findViewById(R.id.txtDes);
        ...
        convertView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, ViewMyBookings_User.class);
