...
public class ManageTrips extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = findViewById(R.id.ListViewTrips);
        ...
        nav1.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                if (item.getItemId() == R.id.TAMenu_Home) {
                    ...
                    new AlertDialog.Builder(ManageTrips.this).setIcon(R.drawable.ic_baseline_warning_24)
                    ...
                    final Dialog dialog = new Dialog(ManageTrips.this);
                    ...
                    try {
                        ...
                        Toast.makeText(ManageTrips.this, "Error", Toast.LENGTH_SHORT).show();
                    }
    ...
    private void GetTrips(int TA_id) {
        ...
        call.enqueue(new Callback<JsonObject>() {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (response.code() == 200) {
                        try {
                            ...
                            TripAdapter adapter = new TripAdapter(ManageTrips.this, tripsList);
            ...
            public void onFailure(Call<JsonObject> call, Throwable t) {
                progressDialog.dismiss();
                Toast.makeText(ManageTrips.this,
